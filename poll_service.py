...
from models import Poll, PollOption, Vote, save_poll, get_poll_by_id, save_vote, delete_vote

logger = logging.getLogger(__name__)

class PollService:
    @staticmethod
    def create_poll(question, creator_id, options, allow_multiple_votes=False, hide_votes=False, deadline=None, channel_id=None):
        """
        Create a new poll
    ...
    def get_poll_results(poll_id):
        ...
        for option in poll.options:
            ...
            if not poll.hide_votes:
                option_result["voters"] = [{"id": vote.user_id, "name": vote.user_name} for vote in votes]
